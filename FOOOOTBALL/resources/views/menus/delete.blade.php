<div id="dropdown-content">
                    <div class="flex justify-around bottom-4"> <!-- contenidor menus -->
                        <div class="flex-1 mx-8"> <!-- contenidor menu team -->
                            <h4 class="text-2xl font-semibold text-center text-red-400 dark:text-gray-400">NEW TEAM</h4>
                            <form action="/ruta-al-controlador" method="POST" class="w-full mt-8">
                                <div class="mb-4">
                        ...
                        <div class="flex-1 mx-8"> <!-- contenidor menu match -->
                            <h4 class="text-2xl font-semibold text-center text-red-400 dark:text-gray-400">NEW MATCH</h4>
                            <form action="/ruta-al-controlador" method="POST" class="w-full mt-8">
                    ...
                    <button type="submit" class="w-12 h-12 bg-red-600 text-white 
