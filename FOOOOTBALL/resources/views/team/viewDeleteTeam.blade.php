<div id="dropdown-content">
    ...
    <div class="flex flex-col items-center relative border-2 border-red-400 rounded-lg p-8 mx-8 max-h-64 bottom-8">
    <h4 class="absolute -top-4 w-52 bg-gray-100 text-red-400">CONFIRM DELETE</h4>
        ...
        <div class="flex flex-col justify-around">
            <div class="flex items-center justify-center mx-4 my-8">
                <form id="deleteTeam" action="{{ route('teams.delete', ['id' => $team->id]) }}" method="POST">
                @csrf
